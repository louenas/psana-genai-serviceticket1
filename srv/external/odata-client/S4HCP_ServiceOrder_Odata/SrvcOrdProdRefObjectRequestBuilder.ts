 ...
 */
export class SrvcOrdProdRefObjectRequestBuilder<
...
> extends RequestBuilder<SrvcOrdProdRefObject<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<SrvcOrdProdRefObject<T>, T> {
    return new GetAllRequestBuilder<SrvcOrdProdRefObject<T>, T>(this.entityApi);
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<SrvcOrdProdRefObject<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<SrvcOrdProdRefObject<T>, T>(
      this.entityApi,
      {
  ...
  delete(
    ...
    return new DeleteRequestBuilder<SrvcOrdProdRefObject<T>, T>(
      this.entityApi,
      serviceOrderOrEntity instanceof SrvcOrdProdRefObject
