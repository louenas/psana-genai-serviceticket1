 ...
 */
export class ServiceOrderRefObjectRequestBuilder<
...
> extends RequestBuilder<ServiceOrderRefObject<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<ServiceOrderRefObject<T>, T> {
    return new GetAllRequestBuilder<ServiceOrderRefObject<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<ServiceOrderRefObject<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<ServiceOrderRefObject<T>, T>(
      this.entityApi,
      {
  ...
  delete(
    ...
    return new DeleteRequestBuilder<ServiceOrderRefObject<T>, T>(
      this.entityApi,
      serviceOrderOrEntity instanceof ServiceOrderRefObject
