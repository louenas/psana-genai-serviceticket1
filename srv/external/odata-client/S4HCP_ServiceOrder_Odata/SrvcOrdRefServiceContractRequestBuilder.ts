 ...
 */
export class SrvcOrdRefServiceContractRequestBuilder<
...
> extends RequestBuilder<SrvcOrdRefServiceContract<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<SrvcOrdRefServiceContract<T>, T> {
    return new GetAllRequestBuilder<SrvcOrdRefServiceContract<T>, T>(
      this.entityApi
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<SrvcOrdRefServiceContract<T>, T>(
      this.entityApi,
      {
