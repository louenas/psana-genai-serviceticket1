 ...
 */
export class ServiceOrderTextRequestBuilder<
...
> extends RequestBuilder<ServiceOrderText<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<ServiceOrderText<T>, T> {
    return new GetAllRequestBuilder<ServiceOrderText<T>, T>(this.entityApi);
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<ServiceOrderText<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<ServiceOrderText<T>, T>(this.entityApi, {
  ...
  update(
    ...
    return new UpdateRequestBuilder<ServiceOrderText<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<ServiceOrderText<T>, T>(
      this.entityApi,
      serviceOrderOrEntity instanceof ServiceOrderText
