...
export class SrvcOrdPartnerAddressApi<
...
> implements EntityApi<SrvcOrdPartnerAddress<DeSerializersT>, DeSerializersT>
{
  ...
  entityConstructor = SrvcOrdPartnerAddress;

  requestBuilder(): SrvcOrdPartnerAddressRequestBuilder<DeSerializersT> {
    return new SrvcOrdPartnerAddressRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<SrvcOrdPartnerAddress<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    SERVICE_ORDER: OrderableEdmTypeField<
      SrvcOrdPartnerAddress<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    TRANSPORT_ZONE: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<SrvcOrdPartnerAddress<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', SrvcOrdPartnerAddress)
      };
    }
