...
import { ServiceOrderItemRefObjectRequestBuilder } from './ServiceOrderItemRefObjectRequestBuilder';
import {
  CustomField,
...
export class ServiceOrderItemRefObjectApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<ServiceOrderItemRefObject<DeSerializersT>, DeSerializersT>
{
  ...
  entityConstructor = ServiceOrderItemRefObject;

  requestBuilder(): ServiceOrderItemRefObjectRequestBuilder<DeSerializersT> {
    return new ServiceOrderItemRefObjectRequestBuilder<DeSerializersT>(this);
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof ServiceOrderItemRefObject,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    SERVICE_ORDER: OrderableEdmTypeField<
      ServiceOrderItemRefObject<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    SRVC_REF_OBJ_IS_MAIN_OBJECT: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<ServiceOrderItemRefObject<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ServiceOrderItemRefObject)
      };
    }
