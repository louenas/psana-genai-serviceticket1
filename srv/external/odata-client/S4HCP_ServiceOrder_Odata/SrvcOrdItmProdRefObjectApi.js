...
exports.SrvcOrdItmProdRefObjectApi = void 0;
/*
...
const SrvcOrdItmProdRefObjectRequestBuilder_1 = require("./SrvcOrdItmProdRefObjectRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class SrvcOrdItmProdRefObjectApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = SrvcOrdItmProdRefObject_1.SrvcOrdItmProdRefObject;
    ...
    requestBuilder() {
        return new SrvcOrdItmProdRefObjectRequestBuilder_1.SrvcOrdItmProdRefObjectRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(SrvcOrdItmProdRefObject_1.SrvcOrdItmProdRefObject, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', SrvcOrdItmProdRefObject_1.SrvcOrdItmProdRefObject)
            };
        }
        return this._schema;
    }
}
exports.SrvcOrdItmProdRefObjectApi = SrvcOrdItmProdRefObjectApi;
//# sourceMappingURL=SrvcOrdItmProdRefObjectApi.js.map