 ...
 */
export class ServiceOrderItemRefObjectRequestBuilder<
...
> extends RequestBuilder<ServiceOrderItemRefObject<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<ServiceOrderItemRefObject<T>, T> {
    return new GetAllRequestBuilder<ServiceOrderItemRefObject<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<ServiceOrderItemRefObject<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<ServiceOrderItemRefObject<T>, T>(
      this.entityApi,
      {
  ...
  delete(
    ...
    return new DeleteRequestBuilder<ServiceOrderItemRefObject<T>, T>(
      this.entityApi,
      serviceOrderOrEntity instanceof ServiceOrderItemRefObject
