 ...
 */
export class ServiceOrderPersonRespRequestBuilder<
...
> extends RequestBuilder<ServiceOrderPersonResp<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<ServiceOrderPersonResp<T>, T> {
    return new GetAllRequestBuilder<ServiceOrderPersonResp<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<ServiceOrderPersonResp<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<ServiceOrderPersonResp<T>, T>(
      this.entityApi,
      {
  ...
  update(
    ...
    return new UpdateRequestBuilder<ServiceOrderPersonResp<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<ServiceOrderPersonResp<T>, T>(
      this.entityApi,
      serviceOrderOrEntity instanceof ServiceOrderPersonResp
