...
exports.SrvcOrdPartnerAddressApi = void 0;
/*
 * Copyright (c) 2024 SAP SE or an SAP affiliate company. All rights reserved.
 *
 * This is a generated file powered by the SAP Cloud SDK for JavaScript.
 */
const SrvcOrdPartnerAddress_1 = require("./SrvcOrdPartnerAddress");
const SrvcOrdPartnerAddressRequestBuilder_1 = require("./SrvcOrdPartnerAddressRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class SrvcOrdPartnerAddressApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = SrvcOrdPartnerAddress_1.SrvcOrdPartnerAddress;
    ...
    static _privateFactory(deSerializers = odata_v2_1.defaultDeSerializers) {
        return new SrvcOrdPartnerAddressApi(deSerializers);
    }
    ...
    requestBuilder() {
        return new SrvcOrdPartnerAddressRequestBuilder_1.SrvcOrdPartnerAddressRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(SrvcOrdPartnerAddress_1.SrvcOrdPartnerAddress, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', SrvcOrdPartnerAddress_1.SrvcOrdPartnerAddress)
            };
        }
        return this._schema;
    }
}
exports.SrvcOrdPartnerAddressApi = SrvcOrdPartnerAddressApi;
//# sourceMappingURL=SrvcOrdPartnerAddressApi.js.map