...
export function batch<DeSerializersT extends DeSerializers>(
  ...
  return new ODataBatchRequestBuilder(
    defaultS4HcpServiceOrderOdataPath,
...
export function changeset<DeSerializersT extends DeSerializers>(
  first:
    | undefined
    | WriteS4HcpServiceOrderOdataRequestBuilder<DeSerializersT>
    | Array<WriteS4HcpServiceOrderOdataRequestBuilder<DeSerializersT>>,
  ...rest: Array<WriteS4HcpServiceOrderOdataRequestBuilder<DeSerializersT>>
): BatchChangeSet<DeSerializersT> {
  return new BatchChangeSet(transformVariadicArgumentToArray(first, rest));
}

export const defaultS4HcpServiceOrderOdataPath =
