 ...
 */
export class ServiceOrderDefectRequestBuilder<
...
> extends RequestBuilder<ServiceOrderDefect<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<ServiceOrderDefect<T>, T> {
    return new GetAllRequestBuilder<ServiceOrderDefect<T>, T>(this.entityApi);
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<ServiceOrderDefect<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<ServiceOrderDefect<T>, T>(
      this.entityApi,
      {
  ...
  update(
    ...
    return new UpdateRequestBuilder<ServiceOrderDefect<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<ServiceOrderDefect<T>, T>(
      this.entityApi,
      serviceOrderOrEntity instanceof ServiceOrderDefect
