 ...
 */
export class ServiceOrderConfirmationRequestBuilder<
...
> extends RequestBuilder<ServiceOrderConfirmation<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<ServiceOrderConfirmation<T>, T> {
    return new GetAllRequestBuilder<ServiceOrderConfirmation<T>, T>(
      this.entityApi
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<ServiceOrderConfirmation<T>, T>(
      this.entityApi,
      {
