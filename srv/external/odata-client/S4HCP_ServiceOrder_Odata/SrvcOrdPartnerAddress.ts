...
import type { SrvcOrdPartnerAddressApi } from './SrvcOrdPartnerAddressApi';

/**
 * This class represents the entity "A_SrvcOrdPartnerAddress" of service "API_SERVICE_ORDER_SRV".
 */
export class SrvcOrdPartnerAddress<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements SrvcOrdPartnerAddressType<T>
{
  /**
   * Technical entity name for SrvcOrdPartnerAddress.
   */
  static _entityName = 'A_SrvcOrdPartnerAddress';
  /**
  ...
  constructor(_entityApi: SrvcOrdPartnerAddressApi<T>) {
    super(_entityApi);
  }
}

export interface SrvcOrdPartnerAddressType<
  T extends DeSerializers = DefaultDeSerializers
> {
