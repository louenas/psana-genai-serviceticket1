 ...
 */
export class SrvcOrdAppointmentRequestBuilder<
...
> extends RequestBuilder<SrvcOrdAppointment<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<SrvcOrdAppointment<T>, T> {
    return new GetAllRequestBuilder<SrvcOrdAppointment<T>, T>(this.entityApi);
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<SrvcOrdAppointment<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<SrvcOrdAppointment<T>, T>(
      this.entityApi,
      {
  ...
  update(
    ...
    return new UpdateRequestBuilder<SrvcOrdAppointment<T>, T>(
      this.entityApi,
      entity
    );
  }
