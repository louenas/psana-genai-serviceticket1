...
exports.SrvcOrdItemDurationApi = void 0;
/*
 * Copyright (c) 2024 SAP SE or an SAP affiliate company. All rights reserved.
 *
 * This is a generated file powered by the SAP Cloud SDK for JavaScript.
 */
const SrvcOrdItemDuration_1 = require("./SrvcOrdItemDuration");
const SrvcOrdItemDurationRequestBuilder_1 = require("./SrvcOrdItemDurationRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class SrvcOrdItemDurationApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = SrvcOrdItemDuration_1.SrvcOrdItemDuration;
    ...
    requestBuilder() {
        return new SrvcOrdItemDurationRequestBuilder_1.SrvcOrdItemDurationRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(SrvcOrdItemDuration_1.SrvcOrdItemDuration, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', SrvcOrdItemDuration_1.SrvcOrdItemDuration)
            };
        }
        return this._schema;
    }
}
exports.SrvcOrdItemDurationApi = SrvcOrdItemDurationApi;
//# sourceMappingURL=SrvcOrdItemDurationApi.js.map