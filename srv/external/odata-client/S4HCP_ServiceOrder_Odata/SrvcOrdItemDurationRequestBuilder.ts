 ...
 */
export class SrvcOrdItemDurationRequestBuilder<
...
> extends RequestBuilder<SrvcOrdItemDuration<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<SrvcOrdItemDuration<T>, T> {
    return new GetAllRequestBuilder<SrvcOrdItemDuration<T>, T>(this.entityApi);
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<SrvcOrdItemDuration<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<SrvcOrdItemDuration<T>, T>(
      this.entityApi,
      {
  ...
  update(
    ...
    return new UpdateRequestBuilder<SrvcOrdItemDuration<T>, T>(
      this.entityApi,
      entity
    );
  }
