 ...
 */
export class SrvcOrdItmProdRefObjectRequestBuilder<
...
> extends RequestBuilder<SrvcOrdItmProdRefObject<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<SrvcOrdItmProdRefObject<T>, T> {
    return new GetAllRequestBuilder<SrvcOrdItmProdRefObject<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<SrvcOrdItmProdRefObject<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<SrvcOrdItmProdRefObject<T>, T>(
      this.entityApi,
      {
  ...
  delete(
    ...
    return new DeleteRequestBuilder<SrvcOrdItmProdRefObject<T>, T>(
      this.entityApi,
      serviceOrderOrEntity instanceof SrvcOrdItmProdRefObject
