...
export class SrvcOrdItemAppointmentApi<
...
> implements EntityApi<SrvcOrdItemAppointment<DeSerializersT>, DeSerializersT>
{
  ...
  entityConstructor = SrvcOrdItemAppointment;

  requestBuilder(): SrvcOrdItemAppointmentRequestBuilder<DeSerializersT> {
    return new SrvcOrdItemAppointmentRequestBuilder<DeSerializersT>(this);
  }
  ...
  private _schema?: {
    SERVICE_ORDER: OrderableEdmTypeField<
      SrvcOrdItemAppointment<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    SRVC_DOC_APPT_END_DATE_TIME: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<SrvcOrdItemAppointment<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', SrvcOrdItemAppointment)
      };
    }
