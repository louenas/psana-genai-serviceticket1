 ...
 */
export class ServiceOrderItemTextRequestBuilder<
...
> extends RequestBuilder<ServiceOrderItemText<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<ServiceOrderItemText<T>, T> {
    return new GetAllRequestBuilder<ServiceOrderItemText<T>, T>(this.entityApi);
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<ServiceOrderItemText<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<ServiceOrderItemText<T>, T>(
      this.entityApi,
      {
  ...
  update(
    ...
    return new UpdateRequestBuilder<ServiceOrderItemText<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<ServiceOrderItemText<T>, T>(
      this.entityApi,
      serviceOrderOrEntity instanceof ServiceOrderItemText
